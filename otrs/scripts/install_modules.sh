...
ligero(){
  ...
  su - otrs -c '/opt/otrs/bin/otrs.Console.pl Admin::Package::Install https://github.com/leoviana00/otrs/tree/master/packages/:LigeroRepository-6.0.0.opm --no-ansi --quiet'
